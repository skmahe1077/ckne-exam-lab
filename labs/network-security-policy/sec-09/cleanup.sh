...
# The Issuer/Certificate created by this lab are namespace-scoped (not a
# ClusterIssuer) and are deleted automatically with the namespace above —
# no cluster-scoped resource and no lock to release.
exit 0
