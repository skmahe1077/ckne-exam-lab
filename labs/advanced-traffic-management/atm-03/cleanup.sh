...
# This lab creates only namespaced objects. No cluster-scoped resources and
# no shared-resource lock to release — the GatewayClass "cilium" is
# referenced by name only, never created or modified by this lab.
exit 0
